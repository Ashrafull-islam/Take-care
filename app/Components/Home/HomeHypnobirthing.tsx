    ...
    return(
        ...
        {/* Hypnobirthing */}
          <div className="px-4 md:px-40 text-center">
            ...
            <p className={`${lexend.className}  my-10   text-[#00000099] text-sm md:text-[20px] font-light	  text-justify`}>Hypnobirthing is the use of a number of tools,such as, positive affirmation,meditation,aroma therapy and visualizations to relax the body,maintain positive thoughts and control breathing.Releasing fear or anxiety surrounding birth through regular practice and familiarising our body and mind with them may help avoid unnecessary interventions.</p>

            <p className={`${lexend.className}  my-6 text-[#00000099] text-sm md:text-[20px] font-light	 text-justify	`}>
          ...
          <div className="px-4 md:px-40 my-24 text-center">
            ...
            <p className={`${lexend.className}  text-[#00000099] text-sm md:text-[20px] font-light		my-1 text-justify`}>The Positive Birth Program is a combination of pregnancy/birth education and HypnoBirthing. Most women in the modern world have been led to believe that pregnancy and birth are to be feared, leading the process to become unnecessarily medicalized at certain times.</p>
            
            
          
            <p className={`${lexend.className}  text-[#00000099] text-sm md:text-[20px] font-light		my-1 text-justify`}>The program itself has been created in collaboration with obstetricians, midwives and women of other professions relating to the field, to give women the optimal chance at a positive birth.</p>
            <p className={`${lexend.className}  my-8 text-[#00000099] text-sm md:text-xl font-light	 text-justify	`}>We understand that medical interventions are not only necessary, but lifesaving in certain situations. We simply encourage our mothers to make informed decisions based on up-to-date research, in order to walk away from their births feeling empowered.</p>
          </div>
        </div>
        {/* Another Program  */}
        {/* Program cards  */}
